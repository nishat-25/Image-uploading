  // Config for Chittagong & Dhaka Restaurants
    ...
    // 1. COMBINED FILTER LOGIC (SEARCH + DIVISION DROPDOWN)
    ...
    // 2. DYNAMIC MODAL OPEN / CLOSE LOGIC
    ...
    function updateModalView() {
      const data = restaurantData[activeRestaurantId];
      const fileExt = data.ext || 'jpg'; // Uses 'png' for koithe, 'jpg' for all others
